...
public class UnknownView extends FrameLayout implements DesignerItem {
	...
	public UnknownView(Context ctx) {
		...
		paint.setTextSize(
				TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 18, ctx.getResources().getDisplayMetrics()));
		minSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15,
				ctx.getResources().getDisplayMetrics());
	}
