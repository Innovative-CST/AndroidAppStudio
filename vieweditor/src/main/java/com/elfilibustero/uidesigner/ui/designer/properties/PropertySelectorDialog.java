...
public class PropertySelectorDialog extends PropertyDialog {
    ...
    private List<String> getList() {
        var map =
                ((type == Constants.SELECTOR_TYPE_FLAG)
    ...
    public void onDialogShow() {
        ...
        if (choiceAdapter instanceof SingleChoiceAdapter singleChoice) {
            if (!value.isEmpty()) singleChoice.setSelectedItem(value);
            ...
            if (!value.isEmpty()) multiChoice.setSelectedItem(getFlagValueToList(value));
