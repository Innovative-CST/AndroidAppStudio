...
public class Constants {
    ...
    public static final List<Class<?>> EXCLUDED_CLASS =
            Arrays.asList(
                    AdapterView.class,
                    CalendarView.class,
                    SearchView.class,
