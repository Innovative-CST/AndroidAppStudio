...
public class ViewPaletteHandler {
    ...
    private static int getIconDefault(String name) {
        return switch (name) {
            ...
            case "LinearProgressIndicator", "CircularProgressIndicator" -> R.drawable
                    .ic_item_progressbar;
    ...
    public static ViewBean createPalette(
        ...
        ViewBean.Builder builder =
                ViewBean.builder().setClassName(className).setName(name).setIcon(icon);
