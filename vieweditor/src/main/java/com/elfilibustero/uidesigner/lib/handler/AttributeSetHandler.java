...
public class AttributeSetHandler {
    ...
    public Set<String> getAttributesFor(View view) {
        ...
        Class<?> clazz =
                (view instanceof DesignerItem item) ? item.getClassType() : view.getClass();
    ...
    public Pair<Class<?>, List<String>> getAttributesFor(
        ...
        Optional<Pair<Class<?>, List<String>>> matchingClazz =
                attributes.stream().filter(pair -> pair.first.equals(clazz)).findFirst();
