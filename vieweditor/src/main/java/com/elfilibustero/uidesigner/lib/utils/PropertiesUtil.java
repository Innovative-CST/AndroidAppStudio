...
public class PropertiesUtil {
    ...
    public static int getIconFor(String attr) {
        return switch (attr) {
            ...
            case "layout_gravity",
                    ...
                    "layout_insetEdge" -> R.drawable.ic_property_gravity;
            case "layout_marginBottom",
                    ...
                    "layout_marginTop",
                    "layout_marginRight",
                    "layout_marging" -> R.drawable.ic_property_margin;
            case "padding",
                    "paddingLeft",
                    "paddingStart",
                    "paddingRight",
                    "paddingEnd",
                    "paddingTop",
                    "paddingBottom" -> R.drawable.ic_property_padding;
    ...
    public static String getPropertyValue(String attr, String value) {
        ...
        return switch (name) {
            ...
            case "layout_gravity",
                    ...
                    "layout_insetEdge",
                    "inputType",
                    "textStyle" -> parseFlag(name, value);
            ...
            case "layout_margin",
                    ...
                    "cardCornerRadius",
                    "layout_height",
                    "layout_width" -> resolveDimenSize(name, value);
            default -> value;
        };
    }
    ...
    private static String resolveDimenSize(String name, String value) {
        ...
        if (reference != null) {
            if (hasDimensionSuffix(value)) {
                var intValue = Integer.parseInt(reference.second);
                if (intValue > 0) intValue = ResourceFactory.getInstance().getDip(intValue);
                return String.valueOf(intValue);
            } else {
    ...
    public static String removeDimensionSuffix(String str) {
        if (!hasDimensionSuffix(str)) return str;
