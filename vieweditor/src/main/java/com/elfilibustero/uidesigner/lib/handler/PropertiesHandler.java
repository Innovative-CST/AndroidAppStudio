...
public class PropertiesHandler {
	...
	public void setItemCount(String value) {
		if (view instanceof DesignerListItem listView) {
			if (!hasAttribute("tools:listitem"))
				listView.setItemCount(Integer.parseInt(value));
		}
	}
	...
	public void setLayoutManager(String value) {
		var layoutManager = (LinearLayoutManager) InvokeUtil.create(
		...
		if (layoutManager == null) {
			...
			layoutManager = (GridLayoutManager) InvokeUtil.create(
					resource.getString(value),
	...
	public void setGoneMarginLeft(String value) {
		// InvokeUtil.setField(view.getLayoutParams(), "goneLeftMargin",
		// Float.parseFloat(value));
	}

	public void setGoneMarginTop(String value) {
		// InvokeUtil.setField(view.getLayoutParams(), "goneTopMargin",
		// Float.parseFloat(value));
	}

	public void setGoneMarginRight(String value) {
		// InvokeUtil.setField(view.getLayoutParams(), "goneRightMargin",
		// Float.parseFloat(value));
	}

	public void setGoneMarginBottom(String value) {
		// InvokeUtil.setField(view.getLayoutParams(), "goneBottomMargin",
		// Float.parseFloat(value));
	}
	...
	public void setBehavior(String value) {
		var behavior = (CoordinatorLayout.Behavior) InvokeUtil.create(resource.getString(value), null);
		InvokeUtil.invoke(
				view.getLayoutParams(),
				"setBehavior",
