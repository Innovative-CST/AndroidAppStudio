...
public class PRDownloader {
	 ...
	 *
	 * @param url
	 *            The url on which request is to be made
	 * @param dirPath
	 *            The directory path on which file is to be saved
	 * @param fileName
	 *            The file name with which file is to be saved
	 ...
	 *
	 * @param downloadId
	 *            The downloadId with which request is to be paused
	 */
	 ...
	 *
	 * @param downloadId
	 *            The downloadId with which request is to be resumed
	 */
	 ...
	 *
	 * @param downloadId
	 *            The downloadId with which request is to be cancelled
	 */
	 ...
	 *
	 * @param tag
	 *            The tag with which requests are to be cancelled
	 */
	 ...
	 *
	 * @param downloadId
	 *            The downloadId with which request status is to be checked
