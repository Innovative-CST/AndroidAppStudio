		...
		DeserializerUtils.deserialize(
				...
				new DeserializerUtils.DeserializerListener() {
					...
					public void onSuccessfullyDeserialized(Object object) {
						 ...
						 * If it is ProjectModel then pass to the listener with
						 * onSuccessfullyDeserialized.
						 * If it is not a ProjectModel then call the onFailed with error
						 * FILE_IS_NOT_PROJECT_MODEL.
						 */
