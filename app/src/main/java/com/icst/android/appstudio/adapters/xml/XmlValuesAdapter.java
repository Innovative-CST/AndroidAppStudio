...
public class XmlValuesAdapter extends RecyclerView.Adapter<XmlValuesAdapter.ViewHolder> {
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    if (viewType == 0) {
      AdapterXmlAttributeBinding binding =
          AdapterXmlAttributeBinding.inflate(LayoutInflater.from(parent.getContext()));
      ...
      AdapterXmlElementBinding binding =
          AdapterXmlElementBinding.inflate(LayoutInflater.from(parent.getContext()));
      RecyclerView.LayoutParams layoutParam =
          new RecyclerView.LayoutParams(
              ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
      binding.getRoot().setLayoutParams(layoutParam);
